//密码明文加密EPIN
//var pk = "";
//加密公钥默认为生产公钥.防止忘记添加加上<%@include  file="/common/hmeta.jsp" %>引入公钥在生产上出现错误.
var pk="";
//
//
//////////////////////////////////////////////////////////////////////////////////////////
...
/**
 *登陆加密方式，由新加密方法产生的密文，加上旧加密方法产生的密文
 */
function encryptEPinTwice(pwds, acctId) {
    for (var i = 0; i < pwds.length; i++) {
        var pwd = document.getElementById(pwds[i]+"1");
        var hidPwd = document.getElementById(pwds[i]);
        try{
            hidPwd.value = EncryptEPin(pwd.value, "")+EncryptEPin(pwd.value, acctId);
            pwd.value='';
        } catch(e){
          //  showMsg("请安装ActiveX控件或java虚拟机");
            return false;
